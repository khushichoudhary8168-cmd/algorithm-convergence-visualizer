...
Enter a function ( f(x) ) or differential equation ( dy/dx = f(x, y) )
Select one or more numerical methods
Configure parameters (initial values, tolerance, iterations, step size)
Run the simulation
Analyze results through graphs, tables, and animations
Results
...
Author
Khushi Choudhary Computer Science Engineering Student Aspiring Data Analyst
